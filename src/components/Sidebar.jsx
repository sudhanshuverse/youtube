        ...
        <aside className={`sidebar ${isSidebarOpen ? "sidebar-open" : "sidebar-closed"}`}>
            <div className="sidebar-content">
                ...
                <nav className="sidebar-section">
                    ...
                    <button className={`sidebar-item ${query === "Philosophy" ? "active" : ""}`} onClick={() => handleClick("Philosophy")} >
                    ...
                    <button className={`sidebar-item ${query === "trending" ? "active" : ""}`} onClick={() => handleClick("trending")}>
                    ...
                    <button className={`sidebar-item ${query === "music" ? "active" : ""}`} onClick={() => handleClick("music")}>
                        <svg viewBox="0 0 24 24" className="sidebar-icon">
                    ...
                    <button className={`sidebar-item ${query === "movie trailer" ? "active" : ""}`} onClick={() => handleClick("movie trailer")}>
                    ...
                    <button className={`sidebar-item ${query === "gaming" ? "active" : ""}`} onClick={() => handleClick("gaming")}>
                    ...
                    <button className={`sidebar-item ${query === "shopping" ? "active" : ""}`} onClick={() => handleClick("shopping")}>
                    ...
                    <button className={`sidebar-item ${query === "sports" ? "active" : ""}`} onClick={() => handleClick("sports")}>
                    ...
                    <button className={`sidebar-item ${query === "news" ? "active" : ""}`} onClick={() => handleClick("news")}>
                    ...
                    <button className={`sidebar-item ${query === "AI and ML" ? "active" : ""}`} onClick={() => handleClick("AI and ML")}>
                    ...
                    <button className={`sidebar-item ${query === "podcast" ? "active" : ""}`} onClick={() => handleClick("podcast")}>
                        <svg className='sidebar-icon' xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill='#fff'>
